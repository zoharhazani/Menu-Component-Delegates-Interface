...
namespace Ex04.Menus.Interfaces
{
    public class MainMenu 
    {
        ...
        public MainMenu()
        {
            ...
            m_MenuItem.NameOfSection = "Main Menu Interface";
        }
        ...
        public void Show(List<MenuItem> i_SubMenu)
        {
            ...
            while (isMenuInUse == true)
            {
                ...
                if (userChoice == 0)
                {
                    if (isMainRoot == false)
                    {                       
                        i_SubMenu = NavigateUp(i_SubMenu[0]);                        
                        continue;
                    }
                ...
                //Navigate Down 
                if( i_SubMenu[userChoice - 1].CheckIfHasActionOrSubMenu () == true)
                {
        ...
        public List<MenuItem> NavigateUp(MenuItem i_Item)
        {
            return i_Item.Parent.Parent.SubMenu;
        }
